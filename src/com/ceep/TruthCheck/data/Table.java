...
public class Table implements Storable {
    ...
    /**
     * Lista de tablas a las que se hace referencia en orden de uso Se tiene que
     * cargar despues de que todas las tablas esten creadas
     */
     ...
     *
     * @param tableName
     * @param referencedTableNames
     * @param structure columnas que tiene la tabla en forma de array or vararg
     */
