...
public interface DataAccess {
     ...
     * @throws com.ceep.TruthCheck.exceptions.WriteException
     */
    public void writeData(String storage_name, String data, GameObjectType datatype) throws WriteException;
    /**
     ...
     */
    public void removeData(String storage_name, String data, GameObjectType datatype) throws WriteException, ReadException;
    /**
     ...
     * @throws com.ceep.TruthCheck.exceptions.ReadException 
     */
    public void modifyData(String storage_name, String data, String newData, GameObjectType datatype) throws WriteException, ReadException;
    /**
     ...
     * @throws com.ceep.TruthCheck.exceptions.ReadException 
     */
    public List<String> readData(String storage_name, GameObjectType datatype) throws ReadException;
    /**
     ...
     * @throws com.ceep.TruthCheck.exceptions.ReadException 
     */
    public List<String> searchData(String storage_name, String search, GameObjectType datatype) throws ReadException;
    /**
     ...
     */
    public GameObject parseObject(String stringifiedObject, GameObjectType datatype) throws ObjectCreationException;
    /**
     ...
     */
    public List<GameObject> parseObjects(List<String> stringifiedObjects, GameObjectType datatype) throws ObjectCreationException;
}
